...
TEST_CASE("testMakeSmallMaze", "[weight=10][part2]")
{
    ...
    std::cout << "this 1 is good" << std::endl;
}
...
TEST_CASE("testMakeMazeConnected", "[weight=10][part2]")
{
    ...
    std::cout << "this 2 is good" << std::endl;
}
...
TEST_CASE("testMakeMazeAcyclic", "[weight=10][part2]")
{
    ...
    std::cout << "this 3 is good" << std::endl;
}
...
TEST_CASE("testMakeMazeTree750", "[weight=10][part2][timeout=20000]")
{
    ...
    std::cout << "this 4 is good" << std::endl;
}
...
TEST_CASE("testMakeMazeRandom", "[weight=10][part2]")
{
    ...
    std::cout << "this 5 is good " << std::endl;
}
...
TEST_CASE("testSolveMazeValidPath", "[weight=10][part2]")
{
    ...
    copyMaze(soln, &maze);
    std::cout << std::endl;
    std::cout << "generate solution" << std::endl;
    ...
    std::cout << "this 6 is good " << std::endl;
}
...
TEST_CASE("testSolutionBottomRow", "[weight=10][part2]")
{
    ...
    std::cout << "this 7 is good " << std::endl;
}
...
TEST_CASE("testSolutionCorrectSquare", "[weight=10][part2]")
{
    ...
    std::cout << "this 8 is good " << std::endl;
}
