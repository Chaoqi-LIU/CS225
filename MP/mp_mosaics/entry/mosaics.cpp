...
void makePhotoMosaic(const string& inFile, vector<TileImage>& tiles, int numTiles,
...
int main(int argc, const char** argv) {
    ...
    for (int i = 20; i <= 21; ++i) {
        ...
        cout << endl << "========== mosaics " << i << " ==========" << endl;

        string inFile = "../bases/base" + to_string(i) + ".png";
        string numTilesStr = "100";
        string pixelsPerTileStr = "50";
        string outFile = "../mosaics/mosaic" + to_string(i) + ".png";

        makePhotoMosaic(inFile, tiles, lexical_cast<int>(numTilesStr), lexical_cast<int>(pixelsPerTileStr), outFile);
